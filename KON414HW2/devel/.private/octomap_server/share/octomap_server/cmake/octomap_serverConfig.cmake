...
if("TRUE" STREQUAL "TRUE")
  set(octomap_server_SOURCE_PREFIX /home/kadir/KON414HW2/src/octomap_mapping/octomap_server)
  set(octomap_server_DEVEL_PREFIX /home/kadir/KON414HW2/devel/.private/octomap_server)
  ...
  set(octomap_server_INSTALL_PREFIX /home/kadir/KON414HW2/install)
...
if(NOT "/home/kadir/KON414HW2/devel/.private/octomap_server/include;/home/kadir/KON414HW2/src/octomap_mapping/octomap_server/include;/opt/ros/noetic/include " STREQUAL " ")
  set(octomap_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/kadir/KON414HW2/devel/.private/octomap_server/include;/home/kadir/KON414HW2/src/octomap_mapping/octomap_server/include;/opt/ros/noetic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kadir/KON414HW2/src/octomap_mapping/octomap_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kadir/KON414HW2/devel/.private/octomap_server/lib;/home/kadir/KON414HW2/devel/lib;/opt/ros/noetic/lib)
