...
if("TRUE" STREQUAL "TRUE")
  set(cpr_orchard_gazebo_SOURCE_PREFIX /home/kadir/KON414HW2/src/cpr_gazebo/cpr_orchard_gazebo)
  set(cpr_orchard_gazebo_DEVEL_PREFIX /home/kadir/KON414HW2/devel/.private/cpr_orchard_gazebo)
  ...
  set(cpr_orchard_gazebo_INSTALL_PREFIX /home/kadir/KON414HW2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cpr_orchard_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kadir/KON414HW2/src/cpr_gazebo/cpr_orchard_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kadir/KON414HW2/devel/.private/cpr_orchard_gazebo/lib;/home/kadir/KON414HW2/devel/lib;/opt/ros/noetic/lib)
